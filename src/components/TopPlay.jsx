...
const TopChartCard = ({ song, i, isPlaying, activeSong, handlePauseClick, handlePlayClick }) => (
  <div className={`w-full flex flex-row items-center hover:bg-dg ${activeSong?.title === song?.title ? 'bg-white/20' : 'bg-transparent'} py-2 p-4 rounded-lg cursor-pointer mb-2`}>
